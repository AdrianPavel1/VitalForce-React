...
const AboutMe = () => {
  ...
  useEffect(() => {
    // Ia username-ul din localStorage
    const username = localStorage.getItem("username");

    // Afișează username-ul în consolă
    if (username) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Obține `username` din localStorage
    const username = localStorage.getItem("username");
    console.log("Username from localStorage:", username);
    ...
    // Adaugă `username` în `formData`
    const updatedFormData = {
      ...formData,
      username: username, // Folosește `username`
    };
