...
const Supplements = () => {
  ...
  // Funcția pentru a schimba secțiunea activă
  ...
  return (
    <div>
      ...
      {activeSection === "testosterone" && (
        ...
        >
          <div className={styles.mainSect}>
            <p className={styles.p1}>All about Testosterone Boost</p>
